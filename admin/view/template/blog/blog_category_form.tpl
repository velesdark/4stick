                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                                    ...
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text"
                                                   name="blog_category_description[<?php echo $language['language_id']; ?>][name]"
                                                   value="<?php echo isset($blog_category_description[$language['language_id']]) ? $blog_category_description[$language['language_id']]['name'] : ''; ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text"
                                                   name="blog_category_description[<?php echo $language['language_id']; ?>][page_title]"
                                                   value="<?php echo isset($blog_category_description[$language['language_id']]) ? $blog_category_description[$language['language_id']]['page_title'] : ''; ?>"
                                                   placeholder="<?php echo $entry_page_title; ?>" class="form-control"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea
                                                    name="blog_category_description[<?php echo $language['language_id']; ?>][description]"
                                                    id="description<?php echo $language['language_id']; ?>"
                                                    class="form-control summernote"><?php echo isset($blog_category_description[$language['language_id']]) ? $blog_category_description[$language['language_id']]['description'] : ''; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea
                                                    name="blog_category_description[<?php echo $language['language_id']; ?>][meta_description]"
                                                    class="form-control"><?php echo isset($blog_category_description[$language['language_id']]) ? $blog_category_description[$language['language_id']]['meta_description'] : ''; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text"
                                                   name="blog_category_description[<?php echo $language['language_id']; ?>][meta_keywords]"
                                                   value="<?php echo isset($blog_category_description[$language['language_id']]) ? $blog_category_description[$language['language_id']]['meta_keywords'] : ''; ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="keyword" value="<?php echo $keyword; ?>"
                                           class="form-control" id="input-keyword"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="parent_id" class="form-control">
                                        ...
                                        <option value="<?php echo $blog_category['blog_category_id']; ?>"
                                                selected="selected"><?php echo $blog_category['name']; ?></option>
                                        <?php } else { ?>
                                    ...
                                    <div class="well well-sm" style="height: 150px; overflow: auto;">
                                        ...
                                        <div class="checkbox">
                                            <label>
                                                ...
                                                <input type="checkbox" name="blog_category_store[]"
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left"><select name="blog_category_layout[0][layout_id]"
                                                                      class="form-control">
                                                <option value=""></option>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left"><select
                                                    name="blog_category_layout[<?php echo $store['store_id']; ?>][layout_id]"
                                                    class="form-control">
                                                <option value=""></option>
                                                <?php foreach ($layouts as $layout) { ?>
