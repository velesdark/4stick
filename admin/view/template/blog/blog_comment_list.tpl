    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-comment" formaction="<?php echo $enable; ?>" data-toggle="tooltip"
                        title="<?php echo $text_enable; ?>" class="btn btn-success"><i class="fa fa-check"></i></button>
                <button type="submit" form="form-comment" formaction="<?php echo $disable; ?>" data-toggle="tooltip"
                        title="<?php echo $text_disable; ?>" class="btn btn-warning"><i class="fa  fa-ban"></i></button>
                <button onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-comment').submit() : false;"
                        form="form-comment" formaction="<?php echo $delete; ?>" data-toggle="tooltip" title="Delete"
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td><?php echo $blog_comment['name']; ?><br/>(<?php echo $blog_comment['email']; ?>)
                                </td>
                                <td class="text-right"><?php echo $blog_comment['date_added']; ?></td>
                                <td class="text-right">
                                    <?php if($blog_comment['status']){ ?>
                                    <span class="label label-success"
                                          style="font-size:100%;"><?php echo $text_enabled; ?></span>
                                    <?php }else{ ?>
                                    <span class="label label-danger"
                                          style="font-size:100%;"><?php echo $text_disabled; ?></span>
                                    <?php } ?>
                            </tr>
                            <?php } ?>
                            <?php }else{ ?>
