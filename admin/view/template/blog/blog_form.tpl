                    ...
                    <div class="tab-content">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="blog_description[<?php echo $language['language_id']; ?>][title]"
                                                   class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="blog_description[<?php echo $language['language_id']; ?>][page_title]"
                                                   class="form-control"
                                                   value="<?php echo isset($blog_description[$language['language_id']]) ? $blog_description[$language['language_id']]['page_title'] : ''; ?>"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea
                                                    name="blog_description[<?php echo $language['language_id']; ?>][description]"
                                                    id="description<?php echo $language['language_id']; ?>"
                                                    class="form-control  summernote"><?php echo isset($blog_description[$language['language_id']]) ? $blog_description[$language['language_id']]['description'] : ''; ?></textarea>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-sm-2 control-label"><span data-toggle="tooltip"
                                                                                    title="<?php echo $entry_short_description_h; ?>"><?php echo $entry_short_description; ?></span></label>
                                        <div class="col-sm-10">
                                            <textarea
                                                    name="blog_description[<?php echo $language['language_id']; ?>][short_description]"
                                                    id="short_description<?php echo $language['language_id']; ?>"
                                                    class="form-control"><?php echo isset($blog_description[$language['language_id']]) ? $blog_description[$language['language_id']]['short_description'] : ''; ?></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea
                                                    ...
                                                    class="form-control"><?php echo isset($blog_description[$language['language_id']]) ? $blog_description[$language['language_id']]['meta_description'] : ''; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="blog_description[<?php echo $language['language_id']; ?>][meta_keyword]"
                                                   class="form-control"
                                                   value="<?php echo isset($blog_description[$language['language_id']]) ? $blog_description[$language['language_id']]['meta_keyword'] : ''; ?>"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="blog_description[<?php echo $language['language_id']; ?>][tags]"
                                                   class="form-control"
                                                   value="<?php echo isset($blog_description[$language['language_id']]) ? $blog_description[$language['language_id']]['tags'] : ''; ?>"/>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="keyword" class="form-control"
                                           value="<?php echo $keyword; ?>" id="input-keyword"/>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="tab-links">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="category" value=""
                                           placeholder="<?php echo $entry_category; ?>" class="form-control"/>
                                    <div id="blog-category" class="well well-sm" style="height: 150px; overflow: auto;">
                                        ...
                                        <div id="blog-category<?php echo $blog_category['blog_category_id']; ?>"><i
                                                    class="fa fa-minus-circle"></i> <?php echo $blog_category['name']; ?>
                                            <input type="hidden" name="this_blog_category[]"
                                                   value="<?php echo $blog_category['blog_category_id']; ?>"/>
                                        </div>
                                        <?php } ?>
                                        <?php } ?>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="related" value=""
                                           placeholder="<?php echo $entry_related; ?>" class="form-control"/>
                                    <div id="blog-related" class="well well-sm" style="height: 150px; overflow: auto;">
                                        <?php foreach ($blogs as $blog) { ?>
                                        <?php if (in_array($blog['blog_id'], $related_blog)) { ?>
                                        <div id="blog-related<?php echo $blog['blog_id']; ?>"><i
                                                    class="fa fa-minus-circle"></i> <?php echo $blog['title']; ?>
                                            <input type="hidden" name="related_blog[]"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="related-products" value=""
                                           placeholder="<?php echo $entry_related_products; ?>"
                                           id="input-related-products" class="form-control"/>
                                    ...
                                    <div class="well well-sm" style="height: 150px; overflow: auto;">
                                        ...
                                        <div class="checkbox">
                                            <label>
                                                ...
                                                <input type="checkbox" name="blog_store[]"
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left"><select name="blog_layout[0][layout_id]"
                                                                      class="form-control">
                                                <option value=""></option>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left"><select
                                                    name="blog_layout[<?php echo $store['store_id']; ?>][layout_id]"
                                                    class="form-control">
                                                <option value=""></option>
                                                <?php foreach ($layouts as $layout) { ?>
