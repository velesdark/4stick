    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-settings" data-toggle="tooltip" title="<?php echo $button_save; ?>"
            ...
            <div class="panel-body">
                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-settings"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <legend><h3 style="margin-top:20px;"><?php echo $heading_blog_home; ?></h3></legend>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-10">
                            <ul class="nav nav-tabs" id="language">
                                ...
                                <li><a href="#language<?php echo $language['language_id']; ?>"
                                       data-toggle="tab"><?php if ((float)VERSION >= 2.2) { ?><img
                                                src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png"
                                                title="<?php echo $language['name']; ?>"/><?php } else { ?><img
                                                src="view/image/flags/<?php echo $language['image']; ?>"
                                                title="<?php echo $language['name']; ?>"/><?php } ?> <?php echo $language['name']; ?>
                                    </a></li>
                                <?php } ?>
                            </ul>
                        </div>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control"
                                           value="<?php echo $blogsetting_home_title[$language['language_id']]; ?>"
                                           name="blogsetting_home_title[<?php echo $language['language_id']; ?>]"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control"
                                           value="<?php echo $blogsetting_home_page_title[$language['language_id']]; ?>"
                                           name="blogsetting_home_page_title[<?php echo $language['language_id']; ?>]"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea
                                            name="blogsetting_home_description[<?php echo $language['language_id']; ?>]"
                                            id="block<?php echo $language['language_id']; ?>"
                                            class="form-control"><?php echo isset($blogsetting_home_description[$language['language_id']]) ? $blogsetting_home_description[$language['language_id']] : ''; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea
                                            name="blogsetting_home_meta_description[<?php echo $language['language_id']; ?>]"
                                            id="block<?php echo $language['language_id']; ?>"
                                            class="form-control"><?php echo isset($blogsetting_home_meta_description[$language['language_id']]) ? $blogsetting_home_meta_description[$language['language_id']] : ''; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control"
                                           value="<?php echo $blogsetting_home_meta_keyword[$language['language_id']]; ?>"
                                           name="blogsetting_home_meta_keyword[<?php echo $language['language_id']; ?>]"/>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><span data-toggle="tooltip"
                                                                        title="<?php echo $entry_blogsetting_home_url_h; ?>"><?php echo $entry_blogsetting_home_url; ?></span></label>
                            <div class="col-sm-10">
                        ...
                        <div class="row">
                            <div class="col-sm-2"></div>
                            <div class="col-sm-10">
                                <legend><h3 style="margin-top:20px;"><?php echo $heading_blog_listing; ?></h3></legend>
                        ...
                        <div class="form-group required">
                            ...
                            <div class="col-sm-10">
                                <input name="blogsetting_blogs_per_page" class="form-control"
                                       value="<?php echo $blogsetting_blogs_per_page; ?>"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group required">
                            ...
                            <div class="col-sm-5">
                                <input name="blogsetting_thumbs_w" class="form-control"
                                       value="<?php echo $blogsetting_thumbs_w; ?>"/>
                            </div>
                            <div class="col-sm-5">
                                <input name="blogsetting_thumbs_h" class="form-control"
                                       value="<?php echo $blogsetting_thumbs_h; ?>"/>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-2"></div>
                            <div class="col-sm-10">
                                <legend><h3 style="margin-top:20px;"><?php echo $heading_blog_post; ?></h3></legend>
                            </div>
                        </div>
                        ...
                        <div class="form-group required">
                            <label class="col-sm-2 control-label"><?php echo $entry_blogsetting_thumb_size; ?></label>
                            <div class="col-sm-5">
                                <input name="blogsetting_post_thumbs_w" class="form-control"
                                       value="<?php echo $blogsetting_post_thumbs_w; ?>"/>
                            </div>
                            <div class="col-sm-5">
                                <input name="blogsetting_post_thumbs_h" class="form-control"
                                       value="<?php echo $blogsetting_post_thumbs_h; ?>"/>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-2"></div>
                            <div class="col-sm-10">
                                <legend><h4 style="margin-top:20px;"><?php echo $heading_related; ?></h4></legend>
                            </div>
                        </div>
                        ...
                        <div class="form-group required">
                            ...
                            <div class="col-sm-5">
                                <input name="blogsetting_rel_thumbs_w" class="form-control"
                                       value="<?php echo $blogsetting_rel_thumbs_w; ?>"/>
                            </div>
                            <div class="col-sm-5">
                                <input name="blogsetting_rel_thumbs_h" class="form-control"
                                       value="<?php echo $blogsetting_rel_thumbs_h; ?>"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group required">
                            ...
                            <div class="col-sm-10">
                                <input name="blogsetting_rel_characters" class="form-control"
                                       value="<?php echo $blogsetting_rel_characters; ?>"/>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-2"></div>
                            <div class="col-sm-10">
                                <legend><h4 style="margin-top:20px;"><?php echo $heading_related_products; ?></h4>
                                </legend>
                            </div>
                        </div>
                        ...
                        <div class="form-group required">
                            ...
                            <div class="col-sm-5">
                                <input name="blogsetting_rel_prod_width" class="form-control"
                                       value="<?php echo $blogsetting_rel_prod_width; ?>"/>
                            </div>
                            <div class="col-sm-5">
                                <input name="blogsetting_rel_prod_height" class="form-control"
                                       value="<?php echo $blogsetting_rel_prod_height; ?>"/>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-2"></div>
                            <div class="col-sm-10">
                                <legend><h3 style="margin-top:20px;"><?php echo $heading_comments; ?></h3></legend>
                            </div>
                        </div>
                        ...
                        <div class="form-group required">
                            ...
                            <div class="col-sm-10">
                                <input name="blogsetting_comment_per_page" class="form-control"
                                       value="<?php echo $blogsetting_comment_per_page; ?>"/>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-sm-2 control-label"><span data-toggle="tooltip"
                                                                        title="<?php echo $entry_blogsetting_comment_approve_h; ?>"><?php echo $entry_blogsetting_comment_approve; ?></span></label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><span data-toggle="tooltip"
                                                                        title="<?php echo $entry_blogsetting_comment_notification_h; ?>"><?php echo $entry_blogsetting_comment_notification; ?></span></label>
                            <div class="col-sm-10">
                        ...
                        <div class="row">
                            <div class="col-sm-2"></div>
                            <div class="col-sm-10">
                                <legend><h3 style="margin-top:20px;"><?php echo $heading_author; ?></h3></legend>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-sm-2 control-label"><span data-toggle="tooltip"
                                                                        title="<?php echo $entry_blogsetting_author_change_h; ?>"><?php echo $entry_blogsetting_author_change; ?></span></label>
                            <div class="col-sm-10">
