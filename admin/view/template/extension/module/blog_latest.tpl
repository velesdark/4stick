    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-blog_latest" data-toggle="tooltip" title="<?php echo $button_save; ?>"
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-blog_latest"
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-width">ID Категории</label>
                        <div class="col-sm-10">
                            <input type="text" name="cat_id" value="<?php echo $cat_id; ?>" placeholder=""
                                   id="input-cat_id" class="form-control"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-width">
                            <span data-toggle="tooltip"
                                  title="<?php echo $entry_characters_h; ?>"><?php echo $entry_characters; ?></span></label>
                        <div class="col-sm-10">
                            <input type="text" name="characters" value="<?php echo $characters; ?>"
                                   placeholder="<?php echo $entry_characters; ?>" id="input-limit"
                                   class="form-control"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"
                               for="input-height"><?php echo $entry_thumb_size; ?></label>
                        <div class="col-sm-5">
                            <input type="text" name="width" value="<?php echo $width; ?>" id="input-width"
                                   class="form-control"/>
                        </div>
                        <div class="col-sm-5">
                            <input type="text" name="height" value="<?php echo $height; ?>" id="input-height"
                                   class="form-control"/>
                        </div>
                    </div>
