    ...
    public function getProduct($product_id)
    {
        ...
        if ($query->num_rows) {
            return array(
                ...
                'jan' => $query->row['jan'],
                'isbn' => $query->row['isbn'],
                'image1_title1' => $query->row['image1_title1'],
                'image1_title2' => $query->row['image1_title2'],
                'image1_title3' => $query->row['image1_title3'],
                'image1_title4' => $query->row['image1_title4'],
                'image1_image1' => $query->row['image1_image1'],
                'image1_image2' => $query->row['image1_image2'],
                'image1_image3' => $query->row['image1_image3'],
                'image1_image4' => $query->row['image1_image4'],
                'image2_title1' => $query->row['image2_title1'],
                'image2_title2' => $query->row['image2_title2'],
                'image2_title3' => $query->row['image2_title3'],
                'image2_title4' => $query->row['image2_title4'],
                'image2_image1' => $query->row['image2_image1'],
                'image2_image2' => $query->row['image2_image2'],
                'image2_image3' => $query->row['image2_image3'],
                'image2_image4' => $query->row['image2_image4'],
                'mpn' => $query->row['mpn'],
