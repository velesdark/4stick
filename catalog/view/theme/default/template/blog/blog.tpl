    ...
    <div class="row"><?php echo $column_left; ?>
        ...
        <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
            <div class="blog blog_post">
                ...
                <div class="main_thumb"><img src="<?php echo $blogsetting_post_thumb; ?>"
                ...
                <div class="blog_stats">
                    <?php if($post_author_status){ ?><span><i class="fa fa-user"></i><b
                                class="text"><?php echo $text_posted_by; ?></b> <b class="hl"><?php echo $author; ?></b></span><?php } ?>
                    <?php if($post_date_added_status){ ?><span><i class="fa fa-clock-o"></i><b
                                class="text"><?php echo $text_posted_on; ?></b> <b
                                class="hl"><?php echo $date_added_full; ?></b></span><?php } ?>
                    <?php if($post_page_view_status){ ?><span><i class="fa fa-eye"></i><b
                                class="text"><?php echo $text_read; ?></b> <b
                                class="hl"><?php echo $new_read_counter_value; ?></b></span><?php } ?>
                    <?php if($post_comments_count_status){ ?><span><i class="fa fa-comments"></i><b
                                class="text"><?php echo $text_comments; ?>:</b> <b
                                class="hl"><?php echo $comment_total; ?></b></span><?php } ?>
                </div>
                ...
                <div class="blog_grid_holder blog_products column-<?php echo $rel_prod_per_row; ?>">
                    ...
                    <div class="blog_item blog_product">
                        ...
                        <a class="btn btn-primary"
                           onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');"><?php echo $button_cart; ?></a>
                        <?php } else { ?>
                        <a class="btn btn-primary"
                           onclick="cart.add('<?php echo $product['product_id']; ?>');"><?php echo $button_cart; ?></a>
                        <?php } ?>
                    ...
                    <div class="blog_item">
                        <div class="summary">
                            ...
                            <div class="blog_stats">
                                ...
                                <?php if($date_added_status){ ?><span><i class="fa fa-clock-o"><b
                                                class="text"></i><?php echo $text_posted_on; ?></b> <b
                                ...
                                <?php if($comments_count_status){ ?><span><i class="fa fa-comments"><b
                                                class="text"></i><?php echo $text_comments; ?></b> <b
                                            class="hl"><?php echo $blog['comment_total']; ?></b></span><?php } ?>
                            </div>
                            <?php if(($blog['image']) && ($rel_thumb_status)){ ?>
                            <div class="image">
                                <a href="<?php echo $blog['href']; ?>"><img src="<?php echo $blog['image']; ?>"
                        ...
                        <div class="col-sm-12">
                            <div class="form-group required">
                                <label class="control-label"
                                       for="input-captcha_comment"><?php echo $entry_captcha; ?></label>
                                <div class="input-group">
                                    <span class="input-group-addon captcha_wrap"
                                          style="background:#ffffff;padding:0 10px;"><img
                                                src="index.php?route=blog/blog/captcha" alt=""
