...
<div id="content">
                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product"
                    ...
                    <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                        ...
                        <div class="tab-pane" id="tab-images">
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-image1_title1">
                                    <span data-toggle="tooltip"
                                          title="<?php echo $help_image1_title1; ?>"><?php echo $entry_image1_title1; ?></span>
                                </label>
                                <div class="col-sm-10">
                                    <input type="text" name="image1_title1" value="<?php echo $image1_title1; ?>"
                                           placeholder="<?php echo $entry_image1_title1; ?>" id="input-image1_title1"
                                           class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-image1_image1">
                                    <span data-toggle="tooltip"
                                          title="<?php echo $help_image1_image1; ?>"><?php echo $entry_image1_image1; ?></span>
                                </label>
                                <div class="col-sm-10">
                                    <input type="text" name="image1_image1" value="<?php echo $image1_image1; ?>"
                                           placeholder="<?php echo $entry_image1_image1; ?>" id="input-image1_image1"
                                           class="form-control"/>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-image1_title2">
                                    <span data-toggle="tooltip"
                                          title="<?php echo $help_image1_title2; ?>"><?php echo $entry_image1_title2; ?></span>
                                </label>
                                <div class="col-sm-10">
                                    <input type="text" name="image1_title2" value="<?php echo $image1_title2; ?>"
                                           placeholder="<?php echo $entry_image1_title2; ?>" id="input-image1_title2"
                                           class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-image1_image2">
                                    <span data-toggle="tooltip"
                                          title="<?php echo $help_image1_image2; ?>"><?php echo $entry_image1_image2; ?></span>
                                </label>
                                <div class="col-sm-10">
                                    <input type="text" name="image1_image2" value="<?php echo $image1_image2; ?>"
                                           placeholder="<?php echo $entry_image1_image2; ?>" id="input-image1_image2"
                                           class="form-control"/>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-image1_title3">
                                    <span data-toggle="tooltip"
                                          title="<?php echo $help_image1_title3; ?>"><?php echo $entry_image1_title3; ?></span>
                                </label>
                                <div class="col-sm-10">
                                    <input type="text" name="image1_title3" value="<?php echo $image1_title3; ?>"
                                           placeholder="<?php echo $entry_image1_title3; ?>" id="input-image1_title3"
                                           class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-image1_image3">
                                    <span data-toggle="tooltip"
                                          title="<?php echo $help_image1_image3; ?>"><?php echo $entry_image1_image3; ?></span>
                                </label>
                                <div class="col-sm-10">
                                    <input type="text" name="image1_image3" value="<?php echo $image1_image3; ?>"
                                           placeholder="<?php echo $entry_image1_image3; ?>" id="input-image1_image3"
                                           class="form-control"/>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-image1_title4">
                                    <span data-toggle="tooltip"
                                          title="<?php echo $help_image1_title4; ?>"><?php echo $entry_image1_title4; ?></span>
                                </label>
                                <div class="col-sm-10">
                                    <input type="text" name="image1_title4" value="<?php echo $image1_title4; ?>"
                                           placeholder="<?php echo $entry_image1_title4; ?>" id="input-image1_title4"
                                           class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-image1_image4">
                                    <span data-toggle="tooltip"
                                          title="<?php echo $help_image1_image4; ?>"><?php echo $entry_image1_image4; ?></span>
                                </label>
                                <div class="col-sm-10">
                                    <input type="text" name="image1_image4" value="<?php echo $image1_image4; ?>"
                                           placeholder="<?php echo $entry_image1_image4; ?>" id="input-image1_image4"
                                           class="form-control"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-image2_title1">
                                    <span data-toggle="tooltip"
                                          title="<?php echo $help_image2_title1; ?>"><?php echo $entry_image2_title1; ?></span>
                                </label>
                                <div class="col-sm-10">
                                    <input type="text" name="image2_title1" value="<?php echo $image2_title1; ?>"
                                           placeholder="<?php echo $entry_image2_title1; ?>" id="input-image2_title1"
                                           class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-image2_image1">
                                    <span data-toggle="tooltip"
                                          title="<?php echo $help_image2_image1; ?>"><?php echo $entry_image2_image1; ?></span>
                                </label>
                                <div class="col-sm-10">
                                    <input type="text" name="image2_image1" value="<?php echo $image2_image1; ?>"
                                           placeholder="<?php echo $entry_image2_image1; ?>" id="input-image2_image1"
                                           class="form-control"/>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-image2_title2">
                                    <span data-toggle="tooltip"
                                          title="<?php echo $help_image2_title2; ?>"><?php echo $entry_image2_title2; ?></span>
                                </label>
                                <div class="col-sm-10">
                                    <input type="text" name="image2_title2" value="<?php echo $image2_title2; ?>"
                                           placeholder="<?php echo $entry_image2_title2; ?>" id="input-image2_title2"
                                           class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-image2_image2">
                                    <span data-toggle="tooltip"
                                          title="<?php echo $help_image2_image2; ?>"><?php echo $entry_image2_image2; ?></span>
                                </label>
                                <div class="col-sm-10">
                                    <input type="text" name="image2_image2" value="<?php echo $image2_image2; ?>"
                                           placeholder="<?php echo $entry_image2_image2; ?>" id="input-image2_image2"
                                           class="form-control"/>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-image2_title3">
                                    <span data-toggle="tooltip"
                                          title="<?php echo $help_image2_title3; ?>"><?php echo $entry_image2_title3; ?></span>
                                </label>
                                <div class="col-sm-10">
                                    <input type="text" name="image2_title3" value="<?php echo $image2_title3; ?>"
                                           placeholder="<?php echo $entry_image2_title3; ?>" id="input-image2_title3"
                                           class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-image2_image3">
                                    <span data-toggle="tooltip"
                                          title="<?php echo $help_image2_image3; ?>"><?php echo $entry_image2_image3; ?></span>
                                </label>
                                <div class="col-sm-10">
                                    <input type="text" name="image2_image3" value="<?php echo $image2_image3; ?>"
                                           placeholder="<?php echo $entry_image2_image3; ?>" id="input-image2_image3"
                                           class="form-control"/>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-image2_title4">
                                    <span data-toggle="tooltip"
                                          title="<?php echo $help_image2_title4; ?>"><?php echo $entry_image2_title4; ?></span>
                                </label>
                                <div class="col-sm-10">
                                    <input type="text" name="image2_title4" value="<?php echo $image2_title4; ?>"
                                           placeholder="<?php echo $entry_image2_title4; ?>" id="input-image2_title4"
                                           class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-image2_image4">
                                    <span data-toggle="tooltip"
                                          title="<?php echo $help_image2_image4; ?>"><?php echo $entry_image2_image4; ?></span>
                                </label>
                                <div class="col-sm-10">
                                    <input type="text" name="image2_image4" value="<?php echo $image2_image4; ?>"
                                           placeholder="<?php echo $entry_image2_image4; ?>" id="input-image2_image4"
                                           class="form-control"/>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <table id="option-value<?php echo $option_row; ?>"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-left">
                                                            ...
                                                            <button type="button"
                                                                    onclick="addOptionValue1('<?php echo $option_row; ?>');"
                                                                    data-toggle="tooltip"
                                                                    title="<?php echo $button_option_value_add; ?>"
                                                                    class="btn btn-primary"><i
                                                                        class="fa fa-plus-circle"></i>Добавить значение
                                                            </button>
                                                        </td>
                                                    </tr>
                                                    </tfoot>
    ...
    <script type="text/javascript">
        ...
        function addOptionValue1(option_row) {
            html = '<tr id="option-value-row' + option_value_row + '">';
            html += '  <td class="text-left"><input  type="number" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][option_value_id1]" class="form-control"><input type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][option_value_id]" class="form-control" readonly>';
            //html += $('#option-values' + option_row).html();
        ...
        function addS(ccc, option_row) {
            //console.log('[name="product_option[' + option_row + '][product_option_value][' + ccc + '][option_value_id]1"]');
            $('[name="product_option[' + option_row + '][product_option_value][' + ccc + '][option_value_id1]"]').keyup(function () {
                console.log($('#option-value' + option_row + ' .product_option[' + option_row + '][product_option_value][' + ccc + '][option_value_id]'));
                var img = new Image;
                img.src = $('[name="image1_image1"]').val();
                var z = img.height / img.width;
                console.log(z);
                $(this).next().val($(this).val() + 'x' + Math.round($(this).val() * z));
                price = changePrice(Math.round($(this).val()) * Math.round($(this).val() * z));
                //console.log();
                $('[name="product_option[' + option_row + '][product_option_value][' + ccc + '][price_prefix]"] option[value="="]').attr('selected', 'selected');
                $('[name="product_option[' + option_row + '][product_option_value][' + ccc + '][subtract]"] option[value="0"]').attr('selected', 'selected');
                $('[name="product_option[' + option_row + '][product_option_value][' + ccc + '][price]"]').val(price);
